...
const translations: Record<Language, I18nTranslations> = {
  ja: {
    ...
    heroLead: '2026年度 清教学園高等学校 文化祭の公式鑑賞ガイドです。全21クラス企画のリアルタイム混雑・待機時間や整理券情報、ステージタイムテーブル、校内マップなどを確認できます。',
    heroInfoLabel: '開催案内',
    heroAudience: '在校生・保護者・卒業生・受験生',
    heroDateLabel: '2026年9月開催（2日間）',
    heroVenueLabel: '清教学園キャンパス（本館・新館・特別棟・第一体育館）',
  ...
  en: {
    ...
    heroLead: 'Official guide for the 2026 Seikyo High School Festival. Explore 21 class exhibits with real-time queue times, stage schedules, and campus map.',
    heroInfoLabel: 'Event Details',
    heroAudience: 'Students, Parents, Alumni & Prospective Students',
    heroDateLabel: 'Held September 2026 (2 Days)',
    heroVenueLabel: 'Seikyo Gakuen Campus (Main, New, Special Bldg, Gym 1)',
