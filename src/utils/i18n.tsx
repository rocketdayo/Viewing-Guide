...
const translations: Record<Language, I18nTranslations> = {
  ja: {
    ...
    heroLostAndFound: '落とし物・お困りごとは1階の事務室までお越しください',
    ...
    classesSearchPlaceholder: 'クラス・企画名で検索...',
  ...
  en: {
    ...
    heroLostAndFound: 'Lost & Found / Inquiries: Visit 1F Administrative Office',
    ...
    navFaqDesc: 'Access, Shoes, Lost & Found, FAQs',
    ...
    searchPlaceholder: 'Search by class or project...',
    ...
    faqSubtitle: 'Guidelines for Shirakashi-no-Michi access, shoes, tickets, trash sorting, SNS rules, first aid/AED, and lost & found (Admin Office 1F).',
    faqSearchPlaceholder: 'Search FAQs (e.g., access, shoes, tickets, trash, office, SNS)...',
    ...
    classesSearchPlaceholder: 'Search by class or project...',
