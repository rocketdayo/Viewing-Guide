...
export function getClassCongestionInputUrl(classCode: string): string {
  ...
  return `${CLASS_CONGESTION_BASE_URL}?class=${encodeURIComponent(normalized)}`;
}
  ...
  greetings: [
    {
      ...
      role: '理事長',
      name: '井上 良作',
      themeTitle: 'SGfes2026へようこそ',
      message: `今年も、清教学園中高合同文化祭SGfes2026を開催できますことはこの上ない慶びです。この日を心待ちにして来校くださった皆様を心より歓迎いたします。これまで中心となって引っ張って来てくれた生徒会、コア・メンバー、文化祭実行委員をはじめ、準備に携わったすべての生徒、教職員のみなさんに心より感謝いたします。

この夏、「キング・オブ・ポップ」と呼ばれたマイケル・ジャクソンの伝記的映画『Michael/マイケル』が公開され、世界中の映画館が涙と拍手に包まれ大ヒットを記録しました。その生涯の描き方が一面的であるとの厳しい評価もある中、制作陣はかつての偉大な表現者の輝きを現代の人々の目の前に再現することに徹したのだと思われました。実の甥子が演じたマイケルの「自分には表現したいことが次々と湧いてくるんだ」というセリフに、若者の迸り出る創造性の神聖さを感じました。

クラスや部活動の企画、展示、発表、有志のステージ。その本番を迎えるにあたって、良い評価をもらうために、不安や緊張を覚える人もいるかもしれません。しかし、今日みなさんが届けるのは、誰かからの評価のためではなく、今、目の前にいる友達や、見に来てくれた家族の笑顔、そして何より、自分たち自身が全力で楽しむ姿であるはずです。この２日間が、清教学園でのかけがえのない青春の美しい１ページとなることを願っています。
  ...
  projects: [
    {
      ...
      category: 'アトラクション・体験',
      location: 'C棟 3F 1-A教室',
      building: 'C棟',
      floor: '3F',
      imageUrl: '/classposter/1-A.png',
      posterPdf: '/classposter/1-A.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'C棟 3F 1-B教室',
      building: 'C棟',
      floor: '3F',
      imageUrl: '/classposter/1-B.png',
      posterPdf: '/classposter/1-B.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'C棟 3F 1-C教室',
      building: 'C棟',
      floor: '3F',
      imageUrl: '/classposter/1-C.png',
      posterPdf: '/classposter/1-C.pdf',
    ...
    },
    {
      ...
      category: '縁日・ゲーム',
      location: 'C棟 3F 1-D教室',
      building: 'C棟',
      floor: '3F',
      imageUrl: '/classposter/1-D.png',
      posterPdf: '/classposter/1-D.pdf',
    ...
    },
    {
      ...
      category: '縁日・ゲーム',
      location: 'C棟 2F 1-E教室',
      building: 'C棟',
      floor: '2F',
      imageUrl: '/classposter/1-E.png',
      posterPdf: '/classposter/1-E.pdf',
    ...
    },
    {
      ...
      category: '縁日・ゲーム',
      location: 'C棟 2F 1-F教室',
      building: 'C棟',
      floor: '2F',
      imageUrl: '/classposter/1-F.png',
      posterPdf: '/classposter/1-F.pdf',
    ...
    },
    {
      ...
      category: 'カフェ・飲食',
      location: 'C棟 2F 1-G教室',
      building: 'C棟',
      floor: '2F',
      imageUrl: '/classposter/1-G.png',
      posterPdf: '/classposter/1-G.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'C棟 2F 1-H教室',
      building: 'C棟',
      floor: '2F',
      imageUrl: '/classposter/1-H.png',
      posterPdf: '/classposter/1-H.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'C棟 2F 1-I教室',
      building: 'C棟',
      floor: '2F',
      imageUrl: '/classposter/1-I.png',
      posterPdf: '/classposter/1-I.pdf',
    ...
    },
    {
      ...
      category: 'カフェ・飲食',
      location: 'C棟 2F 1-J教室',
      building: 'C棟',
      floor: '2F',
      imageUrl: '/classposter/1-J.png',
      posterPdf: '/classposter/1-J.pdf',
    ...
    },
    {
      ...
      category: '展示・研究',
      location: 'M棟 B2F 2-A教室',
      building: 'M棟',
      floor: 'B2F',
      imageUrl: '/classposter/2-A.png',
      posterPdf: '/classposter/2-A.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'M棟 B2F 2-B教室',
      building: 'M棟',
      floor: 'B2F',
      imageUrl: '/classposter/2-B.png',
      posterPdf: '/classposter/2-B.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'M棟 B2F 2-C教室',
      building: 'M棟',
      floor: 'B2F',
      imageUrl: '/classposter/2-C.png',
      posterPdf: '/classposter/2-C.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'M棟 B1F 2-D教室',
      building: 'M棟',
      floor: 'B1F',
      imageUrl: '/classposter/2-D.png',
      posterPdf: '/classposter/2-D.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'M棟 B1F 2-E教室',
      building: 'M棟',
      floor: 'B1F',
      imageUrl: '/classposter/2-E.png',
      posterPdf: '/classposter/2-E.pdf',
    ...
    },
    {
      ...
      category: '縁日・ゲーム',
      location: 'M棟 B1F 2-F教室',
      building: 'M棟',
      floor: 'B1F',
      imageUrl: '/classposter/2-F.png',
      posterPdf: '/classposter/2-F.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'M棟 1F 2-G教室',
      building: 'M棟',
      floor: '1F',
      imageUrl: '/classposter/2-G.png',
      posterPdf: '/classposter/2-G.pdf',
    ...
    },
    {
      ...
      category: '縁日・ゲーム',
      location: 'M棟 1F 2-H教室',
      building: 'M棟',
      floor: '1F',
      imageUrl: '/classposter/2-H.png',
      posterPdf: '/classposter/2-H.pdf',
    ...
    },
    {
      ...
      category: 'カフェ・飲食',
      location: 'M棟 1F 2-I教室',
      building: 'M棟',
      floor: '1F',
      imageUrl: '/classposter/2-I.png',
      posterPdf: '/classposter/2-I.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'M棟 B1F 2-J教室',
      building: 'M棟',
      floor: 'B1F',
      imageUrl: '/classposter/2-J.png',
      posterPdf: '/classposter/2-J.pdf',
    ...
    },
    {
      ...
      category: 'アトラクション・体験',
      location: 'M棟 1F 2-K教室',
      building: 'M棟',
      floor: '1F',
      imageUrl: '/classposter/2-K.png',
      posterPdf: '/classposter/2-K.pdf',
